...
function Banner() {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row mt-3 my' >
...
<div className="validator-hint hidden">Enter valid email address</div>
        ...
        <div className=' order-1 w-full md:w-1/2 flex justify-center md:justify-center md:mt-0'>
