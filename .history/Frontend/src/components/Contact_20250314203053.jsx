...
function Contact() {
  return (
    ...
    <div className='flex justify-center mt-30 '>
        <div className='justify-center font-semibold text-2xl  p-10 shadow-amber-950 shadow-md rounded-2xl backdrop-blur-lg transform-3d bg-[url('/book.png')] bg-cover bg-center bg-repeat '>
