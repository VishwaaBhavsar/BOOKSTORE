...
function Contact() {
  return (
    ...
    <div className='flex justify-center mt-30 '>
        <div className='justify-center font-semibold text-2xl  p-10 shadow-amber-950 shadow-md rounded-2xl backdrop-blur-lg transo '>
        <p className='justify-center text-3xl text-gray-800'>Contact Us</p>
