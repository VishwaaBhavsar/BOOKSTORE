...
function Signup() {
  return (
    <>
      <div>
      <div id="my_modal_3" className="moal ">
  <div className="modal-box dark:bg-slate-900 dark:text-white">
    ...
    <div className='flex justify-around '>
        ...
        <p>Not Signup? <Link to='/signup'  className='underline py-7' onClick={()=>{document.getElementById("my_model_3").showModal()}}>Signup</Link></p>
    </div>
  </div>
</div>
      </div>
