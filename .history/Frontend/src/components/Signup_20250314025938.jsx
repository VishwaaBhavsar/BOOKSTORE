...
function Signup() {
  return (
    <>
      ...
      <div id="my_modal_3" className="border-[2px] shadow-md p-5 rounded-md px-3">
  <div className=" justify-around">
    ...
    <div className='py-1 '>
        <p>Name</p>
        <input type="text" placeholder=' Enter your email' className='dark:border-2 rounded-md mt-1 border-2' />
    </div>
    <div className='py-1 '>
        <p>Email</p>
