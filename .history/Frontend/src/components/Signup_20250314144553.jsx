...
function Signup() {
  ...
  <div className=" mdal-box">
    ...
    <div className='flex justify-around mt-4 '>
        ...
        <p>Have Account?{" "} <Button  className='underline ' onClick={()=>{document.getElementById("my_modal_3").showModal()}}>Login</Button></p>{" "}
        <Login/>
    </div>
  </div>
</div>
