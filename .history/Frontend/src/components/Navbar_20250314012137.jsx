...
<label className="swap swap-rotate">
  ...
  <div className> 
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-300 duration-300 cursor-pointer " onClick={(login)=>document.getElementById("my_modal_3").open}>Login</a>
  </div>
</div>
</div>
    </div>
